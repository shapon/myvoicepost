...
// ============================================================
// PUBLIC AUTH SHORTCUTS - /api/v1/p/login and /api/v1/p/register
// (Same functionality as /api/v1/p/auth/login and /api/v1/p/auth/signup)
// ============================================================

// Public Login shortcut (accepts username OR email)
